...
public partial class TiPcComponentsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAuditoriaEvento).HasName("PK__audit_lo__C05175637BB4E5F9");
        ...
        {
            entity.HasKey(e => e.IdAutenticacionProveedor).HasName("PK__autentic__21438632444794FE");
        ...
        {
            entity.HasKey(e => e.IdCarrito).HasName("PK__carrito__83A2AD9C14809044");
        ...
        {
            entity.HasKey(e => e.IdCarritoDescuento).HasName("PK__carrito___A3FB0E25E225217E");
        ...
        {
            entity.HasKey(e => e.IdCarritoItem).HasName("PK__carrito___240DF0BE2A2DD9E1");
        ...
        {
            entity.HasKey(e => e.IdCategoriaAtributo).HasName("PK__categori__327F2EE2D15E492B");
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__categori__CD54BC5AD33338BE");
        ...
        {
            entity.HasKey(e => e.IdCiudad).HasName("PK__ciudad__B7DC4CD549E5F9F5");
        ...
        {
            entity.HasKey(e => e.IdConfiguracion).HasName("PK__configur__16A13EBD7DFC831A");
        ...
        {
            entity.HasKey(e => e.IdContrasenaReseteo).HasName("PK__contrase__CEA4C91ABE3CCF2A");
        ...
        {
            entity.HasKey(e => e.IdCorreoVerificacion).HasName("PK__correo_v__3325020C1BD338A8");
        ...
        {
            entity.HasKey(e => e.IdCotizacion).HasName("PK__cotizaci__9713D17447F28C07");
        ...
        {
            entity.HasKey(e => e.IdDescuento).HasName("PK__descuent__4F9A1A80B7324203");
        ...
        {
            entity.HasKey(e => e.IdAlcance).HasName("PK__descuent__F0D4C06130846B90");
        ...
        {
            entity.HasKey(e => e.IdUso).HasName("PK__descuent__6AE80FBDB590E5C3");
        ...
        {
            entity.HasKey(e => e.IdDevolucion).HasName("PK__devoluci__0BBAEF8D6446D2AA");

            entity.HasOne(d => d.Orden).WithMany(p => p.Devolucions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__devolucio__orden__2EA5EC27");

            entity.HasOne(d => d.Usuario).WithMany(p => p.Devolucions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__devolucio__usuar__2F9A1060");
        });

        modelBuilder.Entity<DevolucionItem>(entity =>
        {
            entity.HasKey(e => e.IdDevolucionItem).HasName("PK__devoluci__54E820306F4D169A");

            entity.HasOne(d => d.Devolucion).WithMany(p => p.DevolucionItems)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__devolucio__devol__32767D0B");

            entity.HasOne(d => d.OrdenItem).WithMany(p => p.DevolucionItems)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__devolucio__orden__336AA144");

            entity.HasOne(d => d.ProductoIntercambio).WithMany(p => p.DevolucionItems).HasConstraintName("FK__devolucio__produ__345EC57D");
        });

        modelBuilder.Entity<Direccion>(entity =>
        {
            entity.HasKey(e => e.IdDireccion).HasName("PK__direccio__25C35D07AF982E68");
        ...
        {
            entity.HasKey(e => e.IdEnvio).HasName("PK__envio__8C48C8CA782786DD");
        ...
        {
            entity.HasKey(e => e.IdEnvioHistorial).HasName("PK__envio_es__C26AFB5C48DB7394");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__error_co__40F9A207DFDDDE51");
        ...
        {
            entity.HasKey(e => e.IdErrorLog).HasName("PK__error_lo__565A9BB170DC74FE");
        ...
        {
            entity.HasKey(e => e.IdEstado).HasName("PK__estado__86989FB206C205B2");
        ...
        {
            entity.HasKey(e => e.IdEstatusDevolucion).HasName("PK__estatus___A87E7E3130D2AFCD");
        });

        modelBuilder.Entity<EstatusEnvio>(entity =>
        {
            entity.HasKey(e => e.IdEstatusEnvio).HasName("PK__estatus___558B51D3B8424E60");
        ...
        {
            entity.HasKey(e => e.IdEstatusPago).HasName("PK__estatus___89D1D33EAB144AFF");
        ...
        {
            entity.HasKey(e => e.IdEstatusReembolso).HasName("PK__estatus___A877BACD7FF04640");
        });

        modelBuilder.Entity<EstatusVentum>(entity =>
        {
            entity.HasKey(e => e.IdEstatusVenta).HasName("PK__estatus___E676626A2E5C03B7");
        ...
        {
            entity.HasKey(e => e.IdFactura).HasName("PK__factura__6C08ED53C6937040");
        ...
        {
            entity.HasKey(e => e.IdImpuesto).HasName("PK__impuesto__8546BDFC489C9510");
        ...
        {
            entity.HasKey(e => e.IdRegla).HasName("PK__impuesto__46D1C19262F05296");
        ...
        {
            entity.HasKey(e => new { e.ProductoId, e.VariacionId }).HasName("PK__inventar__BD553D65A91D4501");
        ...
        {
            entity.HasKey(e => e.IdMovimiento).HasName("PK__inventar__2A071C24EC93BC41");
        ...
        {
            entity.HasKey(e => e.IdMarca).HasName("PK__marca__7E43E99E9BFE9D9A");
        ...
        {
            entity.HasKey(e => e.IdMetodoPago).HasName("PK__metodo_p__85BE0EBC51ED96F7");
        ...
        {
            entity.HasKey(e => e.IdNotificacion).HasName("PK__notifica__8270F9A510B8723F");
        ...
        {
            entity.HasKey(e => e.IdOperadorEnvio).HasName("PK__operador__0109F579D7F49C16");
        ...
        {
            entity.HasKey(e => e.IdOrden).HasName("PK__orden__DD5B8F334801A680");
        ...
        {
            entity.HasKey(e => e.IdOrdenDescuento).HasName("PK__orden_de__3432CEA2CF4656F5");
        ...
        {
            entity.HasKey(e => e.IdDevolucion).HasName("PK__orden_de__0BBAEF8DB76892CE");
        ...
        {
            entity.HasKey(e => e.IdHistorialOrden).HasName("PK__orden_es__45B1AC09EDF82321");
        ...
        {
            entity.HasKey(e => e.IdOrdenItem).HasName("PK__orden_it__ADF7D768038F5646");
        ...
        {
            entity.HasKey(e => e.IdPago).HasName("PK__pago_tra__0941B074CAE3F306");
        ...
        {
            entity.HasKey(e => e.IdPais).HasName("PK__pais__0941A3A7173EA27D");
        });

        modelBuilder.Entity<Producto>(entity =>
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__producto__FF341C0DDFD49395");
        ...
        {
            entity.HasKey(e => e.IdAtributo).HasName("PK__producto__3BB14C887E616734");
        ...
        {
            entity.HasKey(e => e.IdHistorialPrecio).HasName("PK__producto__5EDBC27284BF4645");
        ...
        {
            entity.HasKey(e => e.IdImagen).HasName("PK__producto__27CC268911E890F8");
        ...
        {
            entity.HasKey(e => e.IdResena).HasName("PK__producto__06CD936352F3B8A2");
        ...
        {
            entity.HasKey(e => e.IdVariacion).HasName("PK__producto__950135CE38EF786D");
        ...
        {
            entity.HasKey(e => e.IdHistorialVariacionPrecio).HasName("PK__producto__1B933795FE9241BC");
        ...
        {
            entity.HasKey(e => e.IdProveedor).HasName("PK__proveedo__8D3DFE28616DE978");
        ...
        {
            entity.HasKey(e => e.IdReembolso).HasName("PK__reembols__51DA5136CA58E01F");
        ...
        {
            entity.HasKey(e => e.IdRegla).HasName("PK__regla_de__46D1C192D05532A7");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__rol__6ABCB5E09325A765");
        ...
        {
            entity.HasKey(e => e.IdSeveridad).HasName("PK__severida__9E59231E191DCA5C");
        });

        modelBuilder.Entity<SuscripcionNewsletter>(entity =>
        {
            entity.HasKey(e => e.IdSuscripcion).HasName("PK__suscripc__4E8926BBA94965FF");
        ...
        {
            entity.HasKey(e => e.IdTipoMovimientoInventario).HasName("PK__tipo_mov__D8AF2C3B6E87C6CC");
        ...
        {
            entity.HasKey(e => e.IdTipoToken).HasName("PK__tipo_tok__EBA9B06D40339471");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__usuario__4E3E04ADC1623C09");
        ...
        {
            entity.HasKey(e => e.IdFavorito).HasName("PK__usuario___78F875AE32E838D8");
        ...
        {
            entity.HasKey(e => e.IdItem).HasName("PK__usuario___87C9438B7489BF54");
        ...
        {
            entity.HasKey(e => e.IdLista).HasName("PK__usuario___C100E2E5B441DEA4");
        ...
        {
            entity.HasKey(e => e.IdUsuarioOauth).HasName("PK__usuario___CB87F614359CE02A");
        ...
        {
            entity.HasKey(e => e.IdToken).HasName("PK__usuario___3C2FA9C4A156F7A8");
        ...
        {
            entity.HasKey(e => e.IdZona).HasName("PK__zona_env__67C9361110839AFE");
