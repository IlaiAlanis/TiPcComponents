...
namespace API_TI.Services.Helpers
{
    public static class Mapper
    {
        ...
        #region DescuentoDto
        public static DescuentoDto ToDescuentoDto(Descuento descuentos) 
        {
            return new DescuentoDto
            {
                ...
                TipoDescuento= descuentos.TipoDescuento,
                Valor = descuentos.Valor,
                ValorMaximo = descuentos.ValorMaximo,
                EstaActivo = descuentos.EstaActivo 
            };
        }
