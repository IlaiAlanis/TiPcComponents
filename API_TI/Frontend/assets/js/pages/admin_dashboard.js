// assets/js/pages/admin_dashboard.js

/**
 * Admin Dashboard Page
 * Displays metrics, charts, recent orders, and alerts
 */
...
async function loadDashboardMetrics() {
    try {
        ...
        if (response.success && response.data) {
            ...
            renderLowStockAlerts(dashboardData.lowStockProducts || []);
...
function viewOrder(orderId) {
    window.location.href = `/pages/admin/orders.html?id=${orderId}`;
}
